...
author: kupec
---
Такие **git** операции как удаление и перемещение коммитов довольно опасны.
Владея ими, можно почувствовать уверенность при работе с репозиторием.
...
Нетрудно видеть, что старый коммит остался в целости и сохраности, однако, если на него никто не указывает, то он не отображается в истории коммитов.
